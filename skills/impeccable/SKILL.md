...
- **Workflow or command-selection question:** read [How to use Impeccable](reference/how-to-use.md). Give advice without running project setup or commands unless execution is also requested.

...
Finish with the strongest candidates and the smallest credible test that could change the decision. Read [references/ad-test-and-evidence.md](references/ad-test-and-evidence.md) for visual comparisons and demand evidence. When distribution choice, adoption, or payment is part of the decision, read [references/distribution-fit-and-demand-tests.md](references/distribution-fit-and-demand-tests.md) to diagnose buying readiness and switching costs, examine why now, compare channel fit, and set an observable demand test. For deeper framing, use an available positioning specialist or handle the narrow question directly; an optional specialist must not block the task.

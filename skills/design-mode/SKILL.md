...
For brand-inspired styling, inspect the user's supplied reference or the live site. Use it as visual inspiration within the user's brief and established project design system. Design-mode and Impeccable continue to own implementation and verification.
